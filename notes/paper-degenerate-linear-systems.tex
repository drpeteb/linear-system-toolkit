...
\begin{figure}
 \centering
 \subfloat[]{\includegraphics[width=0.9\columnwidth]{figures/toy-degenerate-F-trace.pdf} \label{subf:toy-F-trace:degenerate}} \\
 \subfloat[]{\includegraphics[width=0.9\columnwidth]{figures/toy-degenerate-F-hist.pdf} \label{subf:toy-F-hist:degenerate}}
 \caption{Toy Model 1: MCMC \protect\subref{subf:toy-F-trace:degenerate} trace plot and \protect\subref{subf:toy-F-hist:degenerate} histogram for the components of $\lgtm$, for the degenerate transition model.}
 \label{fig:toy-F-trace-hist}
\end{figure}

\begin{figure}
 \centering
 \subfloat[]{\includegraphics[width=0.9\columnwidth]{figures/toy-degenerate-Q-trace.pdf} \label{subf:toy-Q-trace:degenerate}} \\
 \subfloat[]{\includegraphics[width=0.9\columnwidth]{figures/toy-degenerate-Q-hist.pdf} \label{subf:toy-Q-hist:degenerate}}
 \caption{Toy Model 1: MCMC \protect\subref{subf:toy-Q-trace:degenerate} trace plot and \protect\subref{subf:toy-Q-hist:degenerate} histogram for the components of $\lgtv$, for the degenerate transition model.}
 \label{fig:toy-Q-trace-hist}
\end{figure}
...
\begin{figure}
 ...
 \caption{Toy Model 1: MCMC autocorrelation plots for $\xi_{\ob{}}$ for \protect\subref{subf:toy-R-acf:basic} the full rank transition model and \protect\subref{subf:toy-R-acf:degenerate} the degenerate transition model.}
 \label{fig:toy-R-acf}
\end{figure}
...
\begin{figure}
 \centering
 \subfloat[]{\includegraphics[width=0.9\columnwidth]{figures/toy2-degenerate-rank-trace.pdf} \label{subf:toy2-rank-trace:degenerate}} \\
 \subfloat[]{\includegraphics[width=0.9\columnwidth]{figures/toy2-degenerate-rank-hist.pdf} \label{subf:toy2-rank-hist:degenerate}}
 \caption{Toy Model 2: MCMC \protect\subref{subf:toy2-rank-trace:degenerate} trace plot and \protect\subref{subf:toy2-rank-hist:degenerate} histogram for $\rank(\lgtv)$ with the degenerate transition model.}
 \label{fig:toy2-rank-trace-hist}
\end{figure}
