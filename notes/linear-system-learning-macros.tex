...
% Markov Chains
\newcommand{\mc}[1]{^{[#1]}}
\newcommand{\mcold}{^{\prime}}
\newcommand{\mcint}{^{\prime\prime}}
\newcommand{\mcintint}{^{\prime\prime\prime}}
\newcommand{\mcnew}{^*}
...
\newcommand{\lspmn}[1]{\hat{m}_{#1}}
\newcommand{\lspvr}[1]{\hat{P}_{#1}}
\newcommand{\lsfmn}[1]{m_{#1}}
\newcommand{\lsfvr}[1]{P_{#1}}
